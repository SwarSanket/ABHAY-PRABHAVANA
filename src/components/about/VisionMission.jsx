      ...
      <div className="container px-4 py-20 mx-auto">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
          <div className="col-span-1 md:col-span-5">
            <h1 className="mb-4 text-3xl font-bold text-fipch-heading text-fipch-orange">OUR MISSION</h1>
          ...
          <div className="col-span-1 md:col-span-5">
            <h1 className="mb-4 text-3xl font-bold md:text-4xl text-fipch-orange">OUR VISION</h1>
