...
const VerticalsSection = () => {
  const verticals = [
    ...
    },
    {
      ...
      description:
        "Firodia Institute of Philosophy, Culture & History (FIPCH): A cultural and educational center, with focus on the Shramana tradition of Jainism.",
      photo: abhayPhoto,
    },
    {
      logo: isjsLogo,
      ...
      description:
        "An academic organization collaborating with many European and American Universities, for promoting Jain studies.",
      photo: isjsPhoto,
    },
  ];
        ...
        {verticals.map((vertical, index) => (
          ...
          >
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-xl font-bold text-fipch-grey">
                {vertical.title}
              </h3>
